...
public:
    ...
    bool loadNetwork();
    // Run inference.
    bool runInference(const std::vector<cv::Mat>& inputFaceChips, std::vector<cv::Mat>& featureVectors_descriptor, std::vector<cv::Mat>& featureVectors_detector_rep, std::vector<cv::Mat>& featureVectors_detector_rel);
private:
    ...
    samplesCommon::ManagedBuffer m_outputBuff_detector_rep;
    samplesCommon::ManagedBuffer m_outputBuff_detector_rel;
    samplesCommon::ManagedBuffer m_outputBuff_imgCopy;
